...
namespace Oracle
{
    ...
    public class GingerOracleConnection : IDatabase, ISQLDatabase
    {
        ...
        public string ConnectionString
        {
            get
            {
                ...
                else
                {
                    ...
                    // string conn = $"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL={Protocol})(HOST={Host})(PORT={Port}))(CONNECT_DATA=(sid={Sid})));User Id={UserId};Password={Password};Data Source={DataSource}";
                    return conn;
                }
            }
            set
        ...
        public IPlatformActionHandler PlatformActionHandler { get => throw new System.NotImplementedException(); set => throw new System.NotImplementedException(); }
        ...
        //{
        //    // TODO: using
        //    //if (mOracleConnection == null || mOracleConnection.State != ConnectionState.Open)
        //    //{
        //    //    OpenConnection();
        //    //}
        ...
        public List<string> GetTableColumns(DataTable tableSchema)
        {
            return null;
